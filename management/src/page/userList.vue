              ...
              <el-collapse style="display: flex;flex-direction: column;">
                ...
                <el-collapse-item v-for="record in recordFilter.data" :title="record.id.toString()">
                  <el-form label-width="30%" class="demo-ruleForm" label-position="right"
                    ...
                    <el-form-item v-for="(latitude, index) in record.latitudeList" :label="'位置经纬度' + index.toString()">
                      <el-input :placeholder="latitude.toString() + '; ' + record.longitudeList[index].toString()"
                                style="width: 25vh" :disabled="true"/>
                    </el-form-item>
